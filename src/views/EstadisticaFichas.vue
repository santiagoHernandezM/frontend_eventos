  ...
  <v-app>
    <v-container>
      ...
      <v-row v-if="nombrecompetencia != null" class="justify-center">
        <v-col>
          <v-chip class="ma-2" color="#81C5E2">
      ...
      <v-row>
        <v-col>
          <BarChart :chartData="chartDataCompetencia" />
        </v-col>
      </v-row>
      <v-row v-if="nombrecompetencia != null" class="justify-center">
        <v-col>
          <v-chip class="ma-2" color="#9BEB33">
      ...
      <v-row>
        ...
        >
          ...
          <BarChart :chartData="data.estructura" />
        </v-col>
      </v-row>
    </v-container>
  </v-app>
  ...
  methods: {
    async fichasprograma() {
      const data = await axios.get(
        `${this.api}/ficha/programas/${this.programa}`
      );
    ...
    graficacompetencia() {
      this.nombrecompetencia = this.comptenciasr.find(
