    ...
    <v-container>
      <v-row justify="space-around">
        <v-card width="100%">
          ...
          >
            ...
            <v-chip class="ma-1" color="rgb(177, 231, 111)" text-color="black">
              Disponible
            </v-chip>
            <v-chip class="ma-1" :color="cocupado" text-color="black">
              Ocupado
            </v-chip>
          </v-app-bar>
      ...
      <v-dialog v-model="dialog" width="600">
        <v-card>
          ...
          <v-card-title> Instructor : {{ paquete.instructor }} </v-card-title>
