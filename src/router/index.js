  ...
  },
  {
    ...
    children: [
...

      {
        ...
        component: () => import("../views/RegionaView.vue"),
      ...
      },
      {
        ...
        component: () => import("../views/BloqueView.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/TipoAmbienteView.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/programa/CrearPrograma.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/programa/CargueMasivoPrograma.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/Competencia/CrearCompetencia.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/Competencia/ListarCompetencia.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      },
      {
        ...
        component: () => import("../views/Instructor/CrearInstructor.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      
      {
        ...
        component: () => import("../views/Ficha/CrearFicha.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find(
      ...
      },
      {
        ...
        component: () => import("../views/EstadisticaFichas.vue"),
      },
      {
        name: "disponibilidad",
      ...
      },
      {
        ...
        component: () => import("../views/Usuario/CrearUsuarioView.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
...

      {
        ...
        component: () => import("../views/Usuario/MasivoUsuarioView.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
          let found = rol.find((element) => element == "Administrator");
          if (found == undefined) return next("/dashboard/welcome");
      ...
      //Coordinador
      {
        ...
        component: () => import("../views/Coordinador/ProgramaInstructor.vue"),
        beforeEnter: (_, __, next) => {
          let rol = store.getters.usuario.roles;
